...
{
    /// <inheritdoc />
    public partial class FixedWrongJaeroProto : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0efa2d19-de65-45bd-a3a8-1305afd6cb26"), "feed.airframes.io", 0, 5552, 1 },
                    { new Guid("24cd028d-4202-4177-b673-75ccf6df2139"), "feed.airframes.io", 4, 5550, 1 },
                    { new Guid("2f48dcc1-190b-4c94-91d6-53900464e8e9"), "feed.airframes.io", 1, 5556, 0 },
                    { new Guid("791e21c8-0763-4dc4-94bf-8241a24d8bec"), "feed.airframes.io", 2, 5571, 1 }
                });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Outputs",
                keyColumn: "Guid",
                keyValue: new Guid("0efa2d19-de65-45bd-a3a8-1305afd6cb26"));

            migrationBuilder.DeleteData(
                table: "Outputs",
                keyColumn: "Guid",
                keyValue: new Guid("24cd028d-4202-4177-b673-75ccf6df2139"));

            migrationBuilder.DeleteData(
                table: "Outputs",
                keyColumn: "Guid",
                keyValue: new Guid("2f48dcc1-190b-4c94-91d6-53900464e8e9"));

            migrationBuilder.DeleteData(
                table: "Outputs",
                keyColumn: "Guid",
                keyValue: new Guid("791e21c8-0763-4dc4-94bf-8241a24d8bec"));
